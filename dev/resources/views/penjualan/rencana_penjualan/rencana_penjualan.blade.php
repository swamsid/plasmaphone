...
<section class="content">
    <div class="container-fluid">
        ...
        @include('penjualan.rencana_penjualan.tambah_rencana_penjualan')
                        ...
                        <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="#tambah_rencana_penjualan" data-toggle="modal">Tambah Data</a></li>
                                    </ul>
                                </li>
                            </ul>
                    </div>
