    ...
    <div class="container-fluid">
        <div class="block-header">
            ...
            <ol class="breadcrumb breadcrumb-bg-blue-grey">
                ...
                <li class="active">Proses Penjualan</li>
            </ol>        

        @include('penjualan.aktivitas_penjualan.proses_penjualan.tambah_proses_penjualan')
                        ...
                        <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="#tambah_proses_penjualan" data-toggle="modal">Tambah Data</a></li>
                                    </ul>
                                </li>
                            </ul>
                    </div>
