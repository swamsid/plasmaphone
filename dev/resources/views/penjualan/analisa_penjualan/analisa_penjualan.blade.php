...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>Analisa Penjualan</h2>
        </div>
            <ol class="breadcrumb breadcrumb-bg-blue-grey">
                <li><a href="{{url('/')}}"><i class="material-icons">home</i> Home</a></li>
                <li>Manajemen Penjualan</li>
                <li class="active">Analisa Penjualan</li>
            </ol>        

        @include('penjualan.analisa_penjualan.tambah_analisa_penjualan')
                        ...
                        <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="#tambah_analisa_penjualan" data-toggle="modal">Tambah Data</a></li>
                                    </ul>
                                </li>
                            </ul>
                    </div>
