								...
								<tr>
									...
									<td><center>{{ $r_order->rdt_kuantitas_approv }}</center></td>
		                                ...
		                                <td class="text-center">
		                                	...
		                                	<button class="btn btn-xs btn-danger btn-circle hapus" data-toggle="tooltip" data-placement="top" title="Hapus Data" data-id="{{ $r_order->rdt_no }}" rel="{{ $r_order->rdt_request }}"><i class="glyphicon glyphicon-trash"></i></button>
		                                </td>
		                            </tr>
		                            @endforeach
		                        </tbody>
