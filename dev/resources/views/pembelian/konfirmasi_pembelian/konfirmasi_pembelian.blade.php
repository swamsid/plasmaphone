...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>Konfimasi Pembelian</h2>
        </div>
            <ol class="breadcrumb breadcrumb-bg-blue-grey">
                <li><a href="{{url('/')}}"><i class="material-icons">home</i> Home</a></li>
                <li>Manajemen Pembelian</li>
                <li class="active">Konfimasi Pembelian</li>
            </ol>        

        @include('pembelian.konfirmasi_pembelian.tambah_konfirmasi_pembelian')
                        ...
                        <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="#tambah_konfimasi_pembelian" data-toggle="modal">Tambah Data</a></li>
                                    </ul>
                                </li>
                            </ul>
                    </div>
