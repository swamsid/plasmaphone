						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center">
									<input type="checkbox" class="check-me" name="data_check[]" data-id="{{$barang->rs_id}}" value="{{ $barang->rs_id }}"/>
								</td>
								<td>{{ $barang->rs_kategori }}</td>
								<td>@if($barang->rs_imei == "") <center> ----- </center> @else {{ $barang->rs_imei }} @endif</td>
								<td>{{ $barang->rs_kode_barang }}</td>
								<td>{{ $barang->rs_nama_barang }}</td>
								<td><center>{{ $barang->rs_qty }}</center></td>
								<td>{{ $barang->rs_tgl_masuk }}</td>
								<td>{{ $barang->s_company }}</td>
								<td class="text-center">
									<button type="button" class="btn btn-xs btn-success btn-circle view" data-toggle="tooltip" data-placement="top" title="View Data" data-id="{{ $barang->rs_id }}"><i class="fa fa-eye fa-fw"></i></button>
									<button class="btn btn-xs btn-success btn-circle edit" data-toggle="tooltip" data-placement="top" title="Edit Data" data-id="{{ $barang->rs_id }}"><i class="fa fa-pencil fa-fw"></i></button>
									<button class="btn btn-xs btn-success btn-circle hapus" data-toggle="tooltip" data-placement="top" title="Hapus Data" data-id="{{ $barang->rs_id }}"><i class="fa fa-eraser fa-fw"></i></button>
								</td>
							</tr>
							@endforeach
						</tbody>
