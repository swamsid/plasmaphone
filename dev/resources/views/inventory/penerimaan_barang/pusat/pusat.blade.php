...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>Penerimaan Barang Dari Pusat</h2>
        </div>
            <ol class="breadcrumb breadcrumb-bg-blue-grey">
                <li><a href="{{url('/')}}"><i class="material-icons">home</i> Home</a></li>
                <li>Manajemen Inventory</li>
                <li>Penerimaan Barang</li>
                <li class="active">Penerimaan Barang Dari Pusat</li>
            </ol>        

        @include('inventory.penerimaan_barang.pusat.tambah_pusat')
                        ...
                        <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="#tambah_pusat" data-toggle="modal">Tambah Data</a></li>
                                    </ul>
                                </li>
                            </ul>
                    </div>
