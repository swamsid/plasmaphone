...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>Penerimaan Barang Dari Suplier</h2>
        </div>
            <ol class="breadcrumb breadcrumb-bg-blue-grey">
                <li><a href="{{url('/')}}"><i class="material-icons">home</i> Home</a></li>
                <li>Manajemen Inventory</li>
                <li>Penerimaan Barang</li>
                <li class="active">Penerimaan Barang Dari Suplier</li>
            </ol>        

        @include('inventory.penerimaan_barang.suplier.tambah_suplier')
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            Penerimaan Barang Dari Suplier
                        </h2>
                        <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="#tambah_suplier" data-toggle="modal">Tambah Data</a></li>
                                    </ul>
                                </li>
                            </ul>
                    </div>
