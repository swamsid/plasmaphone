...
<head>
		<meta charset="utf-8">
		<title> Ups . Method Tidak DiIjinkan</title>
	...
	<body>
	    ...
	    <div class="col-md-12 text-center" style="margin-top: 30px;">
			<h1 style="font-size: 85pt; font-weight: bold;">405</h1> <small style="font-size: 14pt;">Method Tidak DiIjinkan .. <i class="fa fa-frown-o"></i></small>
	    </div>
