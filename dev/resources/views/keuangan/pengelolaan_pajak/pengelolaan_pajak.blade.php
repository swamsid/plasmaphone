...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>Pengelolaan Pajak</h2>
        </div>
            <ol class="breadcrumb breadcrumb-bg-blue-grey">
                <li><a href="{{url('/')}}"><i class="material-icons">home</i> Home</a></li>
                <li>Manajemen Keuangan</li>
                <li class="active">Pengelolaan Pajak</li>
            </ol>        

        @include('keuangan.pengelolaan_pajak.tambah_pengelolaan_pajak')
                        ...
                        <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="#tambah_pengelolaan_pajak" data-toggle="modal">Tambah Data</a></li>
                                    </ul>
                                </li>
                            </ul>
                    </div>
