    ...
    <div class="container-fluid">
        <div class="block-header">
            ...
            <ol class="breadcrumb breadcrumb-bg-blue-grey">
                ...
                <li class="active">Transaksi Memorial</li>
            </ol>        

        @include('keuangan.transaksi_memorial.tambah_transaksi_memorial')
                        ...
                        <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="#tambah_transaksi_memorial" data-toggle="modal">Tambah Data</a></li>
                                    </ul>
                                </li>
                            </ul>
                    </div>
