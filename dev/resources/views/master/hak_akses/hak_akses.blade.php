...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>Master Hak Akses</h2>
        </div>
            <ol class="breadcrumb breadcrumb-bg-blue-grey">
                <li><a href="{{url('/')}}"><i class="material-icons">home</i> Home</a></li>
                <li>Data Master</li>
                <li class="active">Master Hak Akses</li>
            </ol>        

        @include('master.hak_akses.tambah_hak_akses')
                        ...
                        <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="#tambah_akses" data-toggle="modal">Tambah Data</a></li>
                                    </ul>
                                </li>
                            </ul>
                    </div>
