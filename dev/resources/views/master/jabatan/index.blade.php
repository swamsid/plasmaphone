...
<div id="ribbon">
	...
	<!-- breadcrumb -->
	<ol class="breadcrumb">
		<li>Home</li><li>Master</li><li>Master Jabatan</li>
	</ol>
	<!-- end breadcrumb -->
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-7 col-lg-12">
			<ul class="menu-table hide-on-small">
				<li class="">
					<a href="#">
						<i class="fa fa-table"></i> &nbsp;Master Jabatan
					</a>
				</li>

				<li>
					<a href="{{ url('/master/jabatan/add') }}">
	...
	<section id="widget-grid" class="">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding: 0px 20px; margin-top: {{ $mt }};">
				<form id="table-form" method="post" action="{{ url('/master/jabatan/edit-multiple') }}">
					{!! csrf_field() !!}
					<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
						<thead>			                
							<tr>
								...
								<th data-class="expand"><i class="fa fa-fw fa-building text-muted hidden-md hidden-sm hidden-xs"></i> &nbsp;Kode</th>
								<th data-class="expand"><i class="fa fa-fw fa-building text-muted hidden-md hidden-sm hidden-xs"></i> &nbsp;Nama</th>
								<th data-class="expand"><i class="fa fa-fw fa-building text-muted hidden-md hidden-sm hidden-xs"></i> &nbsp;Gaji Pokok</th>
								<th data-class="expand"><i class="fa fa-fw fa-building text-muted hidden-md hidden-sm hidden-xs"></i> &nbsp;Tunjangan Jabatan</th>
								<th data-class="expand"><i class="fa fa-fw fa-building text-muted hidden-md hidden-sm hidden-xs"></i> &nbsp;Tunjangan Kehadiran</th>
								<th data-class="expand"><i class="fa fa-fw fa-building text-muted hidden-md hidden-sm hidden-xs"></i> &nbsp;Tunjangan Makan</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center">
									<input type="checkbox" class="check-me" name="data_check[]" value="{{ $jabatan->id }}"/>
								</td>
								<td>{{ $jabatan->kode }}</td>
								<td>{{ $jabatan->nama }}</td>
								<td>{{ rupiah($jabatan->gaji_pokok) }}</td>
								<td>{{ rupiah($jabatan->tunjangan_jabatan) }}</td>
	...
	$(document).ready(function(){
		...
		$(".hapus").click(function(evt){
			...
			if(ask){
				...
				axios.post(baseUrl+'/master/jabatan/multiple-delete', {
		...
		$(".edit").click(function(evt){
			...
			window.location = baseUrl+'/master/jabatan/edit?id='+context.data('id');
		})
